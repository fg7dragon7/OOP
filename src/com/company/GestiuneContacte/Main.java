...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (optiune != 0) {
            ...
            System.out.println("2.Intregistreaza telefoan");
            System.out.println("3.Afiseaza contacte din telefoan");
            System.out.println("4.Adauga contacte in telefoan");
            ...
            if (optiune == 4) {
                ...
                System.out.println("Intruduce-ti nume");
                String nume = scanner.nextLine();
                System.out.println("Intruduce-te prenume");
